...
public class TestListenerBuildOperationAdapter implements TestListenerInternal {
    ...
    public void completed(TestDescriptorInternal testDescriptor, TestResult testResult, TestCompleteEvent completeEvent) {
        ...
        listener.finished(runningOp.descriptor, new OperationFinishEvent(runningOp.startTime, currentTime, testResult.getException(), new Result(testResult))); // TODO make use of the getFailure().getFailure()
    }
